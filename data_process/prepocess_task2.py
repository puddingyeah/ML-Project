...
pkl_dir = '/root/Project_lys/ML/prj/project/project_data2'
# output_dir = '/data/ml/data'
output_dir = '/root/Project_lys/ML/prj/project/data2'
# next_state_path = '/data/ml/aigtmp/'
next_state_path = '/root/Project_lys/ML/prj/project/aigtmp2/'
log_name = 'preprocess'
